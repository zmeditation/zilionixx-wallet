    ...
    <div class="funiswappairdetail">
        <h1 class="with-back-btn">
            ...
            <span class="funiswappairdetail_title">
                <z-uniswap-pair-symbol v-if="pair.pairAddress" :pair="pair" />
        ...
        <f-card class="funiswappairdetail_info">
            <div class="funiswappairdetail_info_item">
                ...
                <div><z-uniswap-pair-symbol v-if="pair.pairAddress" :pair="pair" no-symbols /></div>
            </div>
            <div class="funiswappairdetail_info_item">
...
import ZUniswapPairSymbol from '../ZUniswapPairSymbol/ZUniswapPairSymbol.vue';
