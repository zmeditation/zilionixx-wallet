                        ...
                        <div class="break-word">
                            ...
                            >
                                <template #popover-text>
                                    ...
                                    Warning: Use this address to receive Opera ZNX only. If you are receiving ZNX-ERC20
...
export default {
    ...
    mounted() {
        ...
        this.blockchain = this.contactData.blockchain || 'zilionixx';
    },
