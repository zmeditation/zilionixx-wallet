<template>
    <div class="funiswap-remove-liquidity funiswap">
        ...
        <div class="funiswap__bottom-box">
            <z-uniswap-pair-liquidity-info :pair="dPair" :from-token="fromToken" :to-token="toToken" />
        </div>
    </div>
</template>
...
import ZUniswapPairLiquidityInfo from '@/components/zuni/ZUniswapPairLiquidityInfo/ZUniswapPairLiquidityInfo.vue';
...
export default {
    name: 'ZUniswapRemoveLiquidity',

    components: { FBackButton, ZUniswapPairLiquidityInfo, FCryptoSymbol, FSlider, FTokenValue, FCard },
